...
class TencentEmbedding(Embedding):
    ...
    settings = {
        'tencent': Setting(os.getcwd()+'/data/Tencent_AILab_ChineseEmbedding_200d.txt',
                           [200], 8824300, 'A corpus on continuous distributed '
                                           'representations of Chinese words and phrases.')
    }

    def __init__(self, name='tencent', d_emb=200, default='none'):
        """
...
if __name__ == '__main__':
    ...
    emb = TencentEmbedding('tencent', d_emb=200)
